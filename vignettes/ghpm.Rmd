...
I can get even more information by combining this query with other issue based queries. Like if I wanted to get the comments made on all the issues associated with `user: HarlanH` that were assigned in the 0.9.0 milestone, I could do:
```{r}
